  ...
  <div class="List">
    <ol class="List__list uk-margin-bottom-remove">
      ...
      >
        ...
        >
        <a v-if="!limitReached" class="assets__item-trash" aria-label="Remove item" @click="removeItem(index)">
            <i class="uk-icon-minus-circle"></i>
        </a>
      </li>
    </ol>
<a class="blok__full-btn uk-margin-small-top" @click="addItem">
<i class="uk-icon-plus-circle uk-margin-small-right"/>Add item</a>
  </div>
</template>
