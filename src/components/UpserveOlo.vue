...
<template v-if="panelShow === 'yourOrder'">
 ...
 <button style="width: 100%;font-size: 24px;padding-top: 3px;width:100%;" @click="panelShowChoose('customerInfo')" class="mt10 fw filehalf" v-else>enter customer info</button>
</template>
...
<button 
v-if="currentOrder.charges.total > 0 && currentOrder.billing.billing_name !== '' && currentOrder.billing.billing_address !== '' && currentOrder.billing.billing_postal_code !== ''"
@click="showGiftcard()" id="cip-pay-btn" class="fw" style="margin-bottom: 20px;">Use Giftcard</button>
<button 
v-else id="cip-pay-btn" class="fw" style="margin-bottom: 20px;" disabled>Use Giftcard</button>
</template>
...
<br>
                <button class="mt0 fw" style="margin-top:10px;" 
                v-if="currentOrder.charges.total > 0 && currentOrder.billing.billing_name !== '' && currentOrder.billing.billing_address !== '' && currentOrder.billing.billing_postal_code !== ''"
                id="cip-pay-btn"
                @click="useGiftCardBalance()"
              >Pay With Giftcard</button>
              <button class="mt0 fw" style="margin-top:10px;" v-else disabled>Pay With Giftcard</button>
    </template>
</template>
<template v-if="giftCardPanel ===  true">
<br>
