...
export default {
  ...
  methods: {
    async lookupBalance() {
      let giftcardLookup = await this.$http.post("https://http://young-hamlet-03679.herokuapp.com/user/lookupgiftcard", {
    ...
    useBalance() {
      ...
      this.$http
        .post("https://http://young-hamlet-03679.herokuapp.com/user/lookupgiftcard", {
          cardNumber: this.cardNumberInput,
        })
        .then(function (response) {
          if (
            ...
            self.$http
              .post("https://http://young-hamlet-03679.herokuapp.com/user/usegiftcard", {
