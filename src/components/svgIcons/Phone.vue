...
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="35.9px"
	 height="56.2px" viewBox="0 0 35.9 56.2" style="enable-background:new 0 0 35.9 56.2;" xml:space="preserve">
<defs>
</defs>
<path :fill="color" d="M30.9,0H5C2.2,0,0,2.2,0,5v46.2c0,2.8,2.2,5,5,5h25.9c2.8,0,5-2.2,5-5V5C35.9,2.2,33.6,0,30.9,0z M15.7,1.8h4.5
	c0.8,0,1.4,0.6,1.4,1.4c0,0.8-0.6,1.4-1.4,1.4h-4.5c-0.8,0-1.4-0.6-1.4-1.4C14.2,2.5,14.9,1.8,15.7,1.8z M17.9,54.7
	c-1.4,0-2.6-1.2-2.6-2.6c0-1.4,1.2-2.6,2.6-2.6s2.6,1.2,2.6,2.6C20.5,53.5,19.4,54.7,17.9,54.7z M31.9,48.1H4V6.5h27.9V48.1z"/>
</svg>-->



<!--
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34.88 54.16"><title>Asset 3</title><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path :fill="color" d="M29.88,0H5A5,5,0,0,0,0,5V49.16a5,5,0,0,0,5,5H29.88a5,5,0,0,0,5-5V5A5,5,0,0,0,29.88,0ZM15.69,1.81h3.5a1.45,1.45,0,0,1,0,2.89h-3.5a1.45,1.45,0,0,1,0-2.89ZM17.44,52.7A2.58,2.58,0,1,1,20,50.12,2.58,2.58,0,0,1,17.44,52.7Zm13.44-6.61H4V6.51H30.88Z"/></g></g></svg>-->

<!--

<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="35.9px"
	 height="54.2px" viewBox="0 0 35.9 54.2" style="enable-background:new 0 0 35.9 54.2;" xml:space="preserve">

<path :fill="color" d="M30.9,0H5C2.2,0,0,2.2,0,5v44.2c0,2.8,2.2,5,5,5h25.9c2.8,0,5-2.2,5-5V5C35.9,2.2,33.6,0,30.9,0z M16.2,1.8h3.5
	c0.8,0,1.4,0.6,1.4,1.4c0,0.8-0.6,1.4-1.4,1.4h-3.5c-0.8,0-1.4-0.6-1.4-1.4C14.7,2.5,15.4,1.8,16.2,1.8z M17.9,52.7
	c-1.4,0-2.6-1.2-2.6-2.6c0-1.4,1.2-2.6,2.6-2.6s2.6,1.2,2.6,2.6C20.5,51.5,19.4,52.7,17.9,52.7z M31.9,46.1H4V6.5h27.9V46.1z"/>
</svg>-->

<!--
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="32.2px"
	 height="45.9px" viewBox="0 0 32.2 45.9" style="enable-background:new 0 0 32.2 45.9;" xml:space="preserve">

<g>
	<g>
		<path :fill="color" d="M27.2,45.9H5c-2.8,0-5-2.2-5-5V5c0-2.8,2.2-5,5-5h22.2c2.8,0,5,2.2,5,5v35.9C32.2,43.7,30,45.9,27.2,45.9z
			 M5,4C4.4,4,4,4.4,4,5v35.9c0,0.6,0.4,1,1,1h22.2c0.6,0,1-0.4,1-1V5c0-0.6-0.4-1-1-1H5z"/>
	</g>
	<g>
		<path :fill="color" d="M14.5,5.6h3.1c0.7,0,1.3,0.6,1.3,1.3c0,0.7-0.6,1.3-1.3,1.3h-3.1c-0.7,0-1.3-0.6-1.3-1.3
			C13.2,6.2,13.8,5.6,14.5,5.6z M16.1,40.3c-1.4,0-2.6-1.2-2.6-2.6c0-1.4,1.2-2.6,2.6-2.6s2.6,1.2,2.6,2.6
			C18.7,39.2,17.5,40.3,16.1,40.3z"/>
	</g>
</g>
</svg>-->
