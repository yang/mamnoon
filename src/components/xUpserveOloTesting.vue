...
<OrderConfirmationModal :orderConfirmationModal="orderConfirmationModal" :orderCMR="orderCMR" />
      ...
      <div v-if="modalOpen" class="order-modal">
              <div class="container modal-body order-modal-width order-modal-body bottomCurves" style="margin-top: 24px;">
        <div class="container online-menu order-modal-width topCurves" style="margin: -16px 0px 16px -16px;width: 160% !important;max-width: calc(100% + 32px) !important;">
...
<!-- <div v-if="item.timing_mask && currentlyAvailable(item.timing_mask.start_time,item.timing_mask.end_time,item.timing_mask.rules,nowDate,nowTime)" class="container menu-line-testing"> -->
...
<!-- <div :id="item.name.replace('- To Go', '').replace('To Go', '').replace(' ','')">
  {{item.name.replace('- To Go', '').replace('To Go', '').replace(' ','')}}
              ...
              <div :id="item.name.replace(/[^0-9a-zA-Z]/g, '').trim()" v-if="item.name !== 'featured item' && item.timing_mask && currentlyAvailable(item.timing_mask.start_time,item.timing_mask.end_time,item.timing_mask.rules,nowDate,nowTime) || !item.timing_mask" class="container menu-line-testing">
                                                ...
                                                >
                                                  <h2 class="menu-header">
                                                    [[v-if="item.timing_mask && currentlyAvailable(item.timing_mask.start_time,item.timing_mask.end_time,item.timing_mask.rules,nowDate,nowTime)"]]
                                       <!-- <div >{{item.id}}</div> -->
...
<template v-for="item in upserveSections">
  ...
  <template v-if="noFiltering">
    <!-- beggin 1 -->
                             <div :id="item.name.replace(/[^0-9a-zA-Z]/g, '').trim()" v-if="item.name !== 'featured item'" class="container menu-line-testing">
...
<!-- {{selectedDate}} -->
<!-- {{selectedTime}} -->
           <div :id="item.name.replace(/[^0-9a-zA-Z]/g, '').trim()" v-if="item.name !== 'featured item' && item.timing_mask && currentlyAvailable(item.timing_mask.start_time,item.timing_mask.end_time,item.timing_mask.rules,selectedDate,selectedTime)" class="container menu-line-testing">
...
<!--[[v-if="item.name !== 'featured item' && item.timing_mask && currentlyAvailable(item.timing_mask.start_time,item.timing_mask.end_time,item.timing_mask.rules,selectedDate,selectedTime)"]]-->
                                ...
                                <div :id="item.name.replace(/[^0-9a-zA-Z]/g, '').trim()" class="container menu-line-testing">
                                                ...
                                                >
                                                  <h2 class="menu-header">
                                                    ...
                                                    [[v-if="item.timing_mask === item.timing_mask"]]
                                                    <!-- <span :id="'plus-'+ item.id" class="expand-contract plus visible">+</span> -->
                                                    <!-- <span :id="'minus-'+ item.id" class="expand-contract minus">-</span> -->
                                                    {{item.name.replace('- To Go', '').replace('To Go', '')}}
                                                    <!-- {{item.timing_mask}} -->
...
<!-- {{item.timing_mask}} -->
         ...
         <template v-if="item.timing_mask === null">
           <!-- no timing mask -->
              <div :id="item.name.replace(/[^0-9a-zA-Z]/g, '').trim()" class="container menu-line-testing" style="display:none;">
...
[[v-if="currentlyAvailable(item.timing_mask.start_time,item.timing_mask.end_time,item.timing_mask.rules,selectedDate,selectedTime)"]]
