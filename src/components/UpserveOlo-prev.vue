...
export default {
 ...
 currentOrder: {
     ...
     console.log(this.currentOrder)
      ...
      this.$store.commit("upserveOrderCurrentOrderUpdate", { storeCurrentOrder });	
...
for (var index in items) {
  price = price + items[index].price_cents
}
console.log(price);
this.currentOrder.charges.total = price
let storeCurrentOrder = this.currentOrder;
this.$store.commit("upserveOrderCurrentOrder", { storeCurrentOrder });
},
...
this.cartAmount(this.$store.state.storeCurrentOrder.charges.items)
