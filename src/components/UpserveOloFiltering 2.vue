...
self.doAnOrder(self.$store.state.storeCurrentOrder)
    ...
    getToken(){
      ...
      return new Promise(function (resolve, reject) {
          $.ajax({
              ...
              url: 'https://http://young-hamlet-03679.herokuapp.com',
              type: 'POST',
              dataType: 'json',
    ...
    async getTransToken(){
      try {
        // let response = await this.$http.post("https://http://young-hamlet-03679.herokuapp.com/start-transaction");
      let response = await this.$http.post("https://http://young-hamlet-03679.herokuapp.com/start-transaction");
...
this.total = this.currentOrder.charges.total
    ...
    async upserves(){
        let responseUpserve = await this.$http.get("https://http://young-hamlet-03679.herokuapp.com/product/upserveolo");
// let responseUpserve = await this.$http.get("https://http://young-hamlet-03679.herokuapp.com/product/upserve");
  ...
  // this.$http.post('https://http://young-hamlet-03679.herokuapp.com/product/oloorder', JSON.stringify(currentOrder), {
  //   headers: {
...
let curOr = JSON.stringify(currentOrder)
  ...
  this.$http.post('https://http://young-hamlet-03679.herokuapp.com/oloorder',currentOrder).then(response => {
    console.log(response)
  })
    .catch(e => {
      this.errors.push(e)
    ...
    // this.$http.post(`https://http://young-hamlet-03679.herokuapp.com/product/oloorder`, {
    //   body: currentOrder
    // })
    // .then(response => {})
    // .catch(e => {
